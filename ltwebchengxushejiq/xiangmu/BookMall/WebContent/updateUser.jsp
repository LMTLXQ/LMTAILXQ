...
<body>
	...
	%>
		ID:<input name="uid" value=<%=id %> readonly>
	...
	<%
		String id = (String)request.getParameter("uid");
	%>
			<form class="form-signin" action="UpdateUserServlet">
				<h2 class="form-signin-heading">修改用户信息：</h2>
				<label for="inputtext" class="sr-only">ID:</label>
				<input type="text" name="uid" value="<%=id %>" class="form-control" placeholder="ID" required autofocus readonly><br>
