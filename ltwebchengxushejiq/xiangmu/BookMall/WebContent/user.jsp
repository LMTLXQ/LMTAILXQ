...
<div class="row">
	...
	<div class="div1 panel panel-primary col-sm-10">
				...
				<tr>
					...
					<td class="td1">
						<div class="btn-group btn-group-sm">
							<a href="updateUser.jsp?uid=<%=user.getUid()%>"><button type="button" class="btn btn-default">修改</button></a> 
							<a href="DeleteUserServlet?uid=<%=user.getUid()%>"><button type="button" class="btn btn-default">删除</button></a>
						</div>
					</td>
				</tr>
		...
		<div class="btn-toolbar" role="toolbar">
			<div class="btn-group">
				<a href="QueryAllUserServlet?currentPage=1">
				<button type="button" class="btn btn-default">首页</button></a> 
				<a href="QueryAllUserServlet?currentPage=<%=p.getCurrentPage()-1%>"><button type="button" class="btn btn-default">上一页</button></a> 
				<a href="#"><button type="button" class="btn btn-default">下一页</button></a> 
				<a href="#"><button type="button" class="btn btn-default">尾页</button></a> 
				<a href="addUser.jsp"><button type="button" class="btn btn-default">新增</button></a>
			</div>
		</div>
		<%
			}
		...
		<div class="btn-toolbar" role="toolbar">
			<div class="btn-group">
				...
				<a
					href="QueryAllUserServlet?currentPage=<%=p.getCurrentPage() + 1%> "><button
						type="button" class="btn btn-default">下一页</button></a> <a
					href="QueryAllUserServlet?currentPage=<%=p.getTotalPage()%>"><button
						type="button" class="btn btn-default">尾页</button></a> <a
					href="addUser.jsp"><button type="button"
		...
		<div class="btn-toolbar" role="toolbar">
			<div class="btn-group">
				<a href="QueryAllUserServlet?currentPage=1"><button
